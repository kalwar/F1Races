...
<body>
  ...
  <h1>
    F1 Races in {{ $races[0]['season'] ?? '2025' }}
  </h1>
  ...
  <div style="width: 100%; max-width: 64rem; margin: 0 auto;">
    ...
    <div class="race-card">
      ...
      <div class="text-section">
        <h2>
          <a href="https://en.wikipedia.org/wiki/{{ str_replace(' ', '_', $race['raceName']) }}" target="_blank">
            {{ $race['raceName'] }}
          </a>
        </h2>
        <p><strong>Circuit:</strong> {{ $race['Circuit']['circuitName'] }}</p>
        <p><strong>Location:</strong> {{ $race['Circuit']['Location']['locality'] }},
